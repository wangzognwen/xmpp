    ...
    public static MessageEntity convertToEntity(Message message){
      /*  String body = message.getBody();
        try {
            ...
            int fromUserId = Integer.parseInt(ConfigUtil.getCurrentLoginUserName(message.getFrom()));
            int toUserId = Integer.parseInt(ConfigUtil.getCurrentLoginUserName(message.getTo()));
